    ...
    <div className="order-detail-container" onClick={toggleNav}>
      ...
      <div className="order-detail-contents">
        <div className="order-items">
          <img
            src="https://99designs-blog.imgix.net/blog/wp-content/uploads/2017/11/Tshirt-design.jpg?auto=format&q=60&w=2060&h=1236&fit=crop&crop=faces"
            alt=""
          />
          <div className="items-detail">
            <p>Gordon College Male Polo</p>
            <p>Large</p>
            <p>x1</p>
            <p>₱42,069</p>
          </div>
        ...
        <div className="user-details">
          ...
          <div>
            ...
            <p>202110203@gordoncollege.edu.ph</p>
          </div>
          <div>
